...
- Final output dataset: `data/imputed_revenue_lag-aware_hierarchical_nowcast.csv`
- Processing logic in `notebook/01_case_study_eda.ipynb`
- Forecasting and nowcasting implementation in `notebook/02_case_study_fct.ipynb`, `utils/model_utils.py`, `utils/forecast_utils.py`, `utils/test_utils.py`
...
- `documentation/repo_cleanup_log.md`
